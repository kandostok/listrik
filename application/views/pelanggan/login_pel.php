...
<body>
	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				...
				?>
				<?php
					$notifikasi = $this->session->flashdata('notif_sukses');
					if ($notifikasi != null) {
						echo '
					...
					<div class="left">
						<div class="content">
							<div class="header">
								...
								<p class="lead">Login Pelanggan PPOB</p>
							</div>
							<form class="form-auth-small" method="post" id="form-login" action="<?php echo base_url('index.php/pelanggan/do_login')?>">
								...
								<br>
								<p>Belum punya akun? <a href="#" data-toggle="modal" data-target="#add_pel">daftar</a></p>
							</form>
						</div>
					</div>
					<div class="right">
	...
	<div class="modal fade" id="add_pel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?=base_url('index.php/pelanggan/add_pelanggan')?>" method="post">
